...
import logo from "./assets/images/Diamastreamadviser.png";
    ...
    <div
      ...
      style={{
        background: currentTVShow
          ? `linear-gradient(rgba(0,0,0,0.60), rgba(0,0,0,0.60)), url("${BACKDROP_BASE_URL}${currentTVShow.backdrop_path}") no-repeat center / cover`
          : "black",
      }}>
      <div className={s.header}>
        <div className="row">
          <div className="col-4">
            <Logo image={logo} title="DiamaStreamADS" subtitle="Diama t'aide à faire tes choix" />
          </div>
